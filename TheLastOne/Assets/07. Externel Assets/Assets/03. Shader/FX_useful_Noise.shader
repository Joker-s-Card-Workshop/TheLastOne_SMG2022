...
Shader "Custom/FX_useful_Noise"
{
	Properties
	{
		...
		_Vector1("Vector 1", Vector) = (0.01,-0.01,0,0)
		_Vector2("Vector 2", Vector) = (-0.01,-0.01,0,0)
		_Vector3("Vector 3", Vector) = (0,0.73,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 panner8 = ( 1.0 * _Time.y * _Vector1 + uv0_DistortTex2);
			float4 tex2DNode1 = tex2D( _DistortTex1, ( panner4 + ( 0.02895365 * (-1.0 + (tex2D( _DistortTex2, panner8 ).r - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ) );
			float2 panner21 = ( 1.0 * _Time.y * _Vector2 + i.uv_texcoord);
			...
			float4 temp_output_13_0 = ( tex2DNode1.r * (-1.0 + (smoothstepResult32 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * ( tex2DNode28.r * ( _Vector3.y + i.uv_tex4coord.w ) ) * i.vertexColor * tex2DNode1.a );
...
/*ASEBEGIN
Version=18301
7;18;1873;993;2817.311;-426.0506;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;9;-2415.013,688.2598;Inherit;False;Property;_Vector1;Vector 1;3;0;Create;True;0;0;False;0;False;0.01,-0.01;0.01,-0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;6;-1893.121,479.5234;Inherit;True;Property;_DistortTex2;DistortTex2;1;0;Create;True;0;0;False;0;False;-1;441d8bb42833455b8b10dd26ce59fffd;cee6e691b28a48b4a7c3bd7a495539e3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;23;-2069.882,1176.178;Inherit;False;Property;_Vector2;Vector 2;5;0;Create;True;0;0;False;0;False;-0.01,-0.01;-0.01,-0.01;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;25;-1229.688,1089.92;Inherit;False;Property;_Vector3;Vector 3;6;0;Create;True;0;0;False;0;False;0,0.73;0,0.73;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;1;-732.1256,401.5117;Inherit;True;Property;_DistortTex1;DistortTex1;0;0;Create;True;0;0;False;0;False;-1;126c2cad90f59334d97a8db3505f7a19;5e287ff1af2f8da41b04be67006b63dd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;34;-213.6219,1048.355;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-33.56647,720.7352;Inherit;True;5;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;COLOR;0,0,0,0;False;4;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;38;144.8457,1219.172;Inherit;True;Property;_MaskTex;MaskTex;4;0;Create;True;0;0;False;0;False;-1;126c2cad90f59334d97a8db3505f7a19;74bbd945fd31fee4ba7280791dd716b8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=218F27B84E193793C1CAEFB1A8F8BEA1D463AC41